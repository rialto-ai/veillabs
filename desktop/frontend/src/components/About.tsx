...
export function About() {
    ...
    const handleContactClick = async () => {
        try {
            await invoke('open_external_url', { url: 'https://veil.computer' });
        } catch (error) {
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes Veil Scribe different</h2>
            ...
            <div className="bg-accent rounded p-3">
                <p className="text-s text-accent-foreground">
            ...
            <div className="text-center space-y-2">
                ...
                <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-primary hover:opacity-90 text-white text-sm font-medium rounded transition-all duration-200 shadow-sm hover:shadow-md"
                >
                    Talk to Veil Labs
                </button>
            </div>
